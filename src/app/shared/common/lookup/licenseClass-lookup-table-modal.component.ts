...
import { LicenseClassesServiceProxy, LicenseClassLookupTableDto } from '@shared/service-proxies/service-proxies';
...
export class LicenseClassLookupTableModalComponent extends AppComponentBase {
    ...
    getAll(event?: LazyLoadEvent) {
        ...
        this._licenseClassesServiceProxy.getAllLicenseClassesForLookupTable(
            this.filterText,
    ...
    setAndSave(lc: LicenseClassLookupTableDto) {
        this.id = lc.id;
        this.displayName = lc.displayName;
        this.active = false;
        this.modal.hide();
