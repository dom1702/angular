...
@Component({
    selector: 'splitInvoiceModal',
    templateUrl: './splitInvoice-modal.component.html',
})
export class SplitInvoiceModalComponent extends AppComponentBase implements OnInit {
